...
ui <- fluidPage(
 ...
 fluidRow(column(2.5,"half page", style="background-color:#996699;color:white;font-size:20px;padding:50px;"),
          column(9.5,"half page", style="background-color:#cc6699;color:white;font-size:20px;padding:50px;"))
